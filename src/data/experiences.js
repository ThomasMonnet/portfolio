...
import PlanetCash from 'src/assets/img/PlanetCash.png';
...
export default [
  ...
  {
    date: '2014-2016',
    type: 'Contrôleur en Intérim',
    enterprise: "Transpole",
    text: "En tant que Contrôleur, je n'étais pas très apprécié. Forcément, vu que les gens voulaient absolument prendre les transports en commun sans ticket ! Mais pour les autres clients, ils étaient ravi d'avoir quelqu'un sur qui s'appuyer pour s'orienter, ou savoir quel ticket ils devaient prendre.",
    img: Transpole
  },
  {
    date: '2013-2014',
